(() => {
  ...
  // ns-hugo:D:\dev\workspaces\my-blog\themes\hugo-theme-bootstrap\assets\search\search.ts
  ...
  // ns-hugo:D:\dev\workspaces\my-blog\themes\hugo-theme-bootstrap\assets\search\engine.ts
  var Engine = class {
    fuse;
    pages = [];
    indices = [];
  ...
  // ns-hugo:D:\dev\workspaces\my-blog\themes\hugo-theme-bootstrap\assets\search\form.ts
  var Form = class {
    constructor(form, callback) {
      this.form = form;
